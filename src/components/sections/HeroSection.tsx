  ...
  return (
    <section className="relative h-[71.6vh] min-h-[580px] overflow-hidden min-[601px]:max-[900px]:h-[80vh] min-[601px]:max-[900px]:min-h-[520px] max-[600px]:h-[100svh] max-[600px]:min-h-0">
      ...
      <div className="absolute inset-0 z-10 mx-auto w-full max-w-[1280px] px-10 max-[600px]:flex max-[600px]:flex-col max-[600px]:justify-center max-[600px]:px-0">
        ...
        <div
          className={`absolute left-10 top-[2.2rem] transition-[opacity,transform] duration-[650ms] ease-[ease] delay-100 motion-reduce:!translate-y-0 motion-reduce:!opacity-100 motion-reduce:!transition-none min-[601px]:max-[900px]:left-[1.8rem] min-[601px]:max-[900px]:top-[1.8rem] max-[600px]:static max-[600px]:mb-[0.9rem] max-[600px]:px-5 max-[360px]:px-4 ${
            vis ? "translate-y-0 opacity-100" : "-translate-y-[14px] opacity-0"
          }`}
        >
