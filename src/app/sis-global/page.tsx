...
const FEATURES = [
  {
    ...
    desc: "AI-powered job recommendations tailored to your skills and experience.",
  },
  {
    icon: <Shield size={20} />,
    title: "Verified Employers",
    desc: "Every company is thoroughly vetted before listing jobs on our platform.",
  },
  {
    icon: <BarChart3 size={20} />,
    title: "Salary Insights",
    desc: "Real-time salary benchmarking data to help candidates negotiate better.",
  },
  {
    icon: <Cpu size={20} />,
    title: "Technology Driven",
    desc: "Our proprietary platform connects talent with opportunity at scale.",
  },
];
...
const VALUES = [
  {
    icon: <Globe size={22} />,
    title: "Inclusivity",
    desc: "Building a platform where everyone has equal opportunity regardless of background, location, or experience.",
  },
  {
    icon: <Lightbulb size={22} />,
    title: "Innovation",
    desc: "Constantly improving how people find jobs and how companies find the right talent, faster.",
  },
  {
    icon: <MessageSquare size={22} />,
    title: "Transparency",
    desc: "Honest communication with candidates, employers, and our own team — always.",
  },
  {
    icon: <Heart size={22} />,
    title: "Impact",
    desc: "Every hire we facilitate is a life changed. That responsibility drives everything we do.",
  },
];
...
const MILESTONES = [
  {
    year: "2019",
    title: "Founded",
    desc: "SIS Global Workforce Solutions incorporated as a venture of SIS India Ltd.",
  },
  {
    year: "2020",
    title: "First 1,000 Jobs",
    desc: "Reached 1,000 active job listings across healthcare and logistics sectors.",
  },
  {
    year: "2021",
    title: "5 Countries",
    desc: "Expanded operations to UAE, Singapore, UK, and Australia.",
  },
  {
    year: "2022",
    title: "Tech Platform",
    desc: "Launched our proprietary AI-powered matching and verification engine.",
  },
  {
    year: "2023",
    title: "25,000 Hires",
    desc: "Surpassed 25,000 successful placements across all industry verticals.",
  },
  {
    year: "2024",
    title: "Global Leader",
    desc: "Recognised as one of India's fastest-growing workforce solutions companies.",
  },
];
    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{
            background:
              "linear-gradient(135deg,#FFF5F6 0%,#FFF0F2 50%,#F5F5F5 100%)",
          }}
        >
          ...
          <div className="absolute right-0 top-0 w-1/2 h-full pointer-events-none overflow-hidden">
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 60% 80% at 80% 40%, rgba(200,16,46,0.06) 0%, transparent 70%)",
              }}
            />
            <div
              className="absolute right-0 top-0 w-full h-full"
              style={{
                background:
                  "radial-gradient(ellipse 40% 60% at 90% 10%, rgba(200,16,46,0.04) 0%, transparent 70%)",
              }}
            />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-20 relative z-10">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-brand-grey-500 text-lg leading-relaxed mb-8 max-w-xl">
                SIS Global Workforce Solutions was founded with one simple
                belief: every person deserves a job that excites them, and every
                company deserves a team that drives them forward.
              </p>
        ...
        <section
          style={{
            background:
              "linear-gradient(90deg,#C8102E 0%,#A00D25 50%,#8B0B1F 100%)",
          }}
        >
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <p className="text-brand-grey-500 leading-relaxed mb-4">
                  Our founding team spent years on both sides of the hiring
                  table — as job seekers frustrated with impersonal platforms,
                  and as hiring managers drowning in unqualified applications.
                </p>
                <p className="text-brand-grey-500 leading-relaxed mb-4">
                  We built SIS Global Workforce Solutions to solve both problems
                  simultaneously: a platform intelligent enough to match the
                  right people with the right roles, and transparent enough that
                  everyone knows where they stand.
                </p>
                <p className="text-brand-grey-500 leading-relaxed mb-8">
                  Backed by SIS India Ltd.&apos;s legacy of operational
                  excellence, we bring decades of domain expertise and a
                  pan-India network to every engagement.
                </p>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-3">
                      ...
                      />
                      <span className="text-sm font-medium text-brand-grey-700">
                        {item}
                      </span>
                    </div>
                  ))}
                ...
                {FEATURES.map((f, i) => (
                  <div
                    ...
                    style={{
                      ...
                      borderColor:
                        i % 2 === 0 ? "rgba(200,16,46,0.15)" : "#E5E5E5",
                    }}
                  >
                    <div
                      ...
                      style={{
                        background:
                          i % 2 === 0 ? "rgba(200,16,46,0.1)" : "#F0F0F0",
                        color: "#C8102E",
                      }}
                    >
                      {f.icon}
                    ...
                    <h3
                      className="font-bold text-brand-grey-900 text-sm mb-2"
                      style={{ fontFamily: "var(--font-display)" }}
                    >
                      {f.title}
                    </h3>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-14">
              ...
              <p className="text-brand-grey-500 mt-3 max-w-xl mx-auto text-sm leading-relaxed">
                A diverse team of passionate professionals committed to your
                success
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {TEAM.map((member) => (
                ...
                >
                  ...
                  <h3
                    className="font-bold text-brand-grey-900 mb-1"
                    style={{ fontFamily: "var(--font-display)", fontSize: 16 }}
                  >
                    {member.name}
                  </h3>
                  <p className="text-brand-red text-xs font-semibold tracking-wide mb-4">
                    {member.role}
                  </p>
                  ...
                  <div className="flex justify-center gap-3">
                    <a
                      href="#"
                      className="w-8 h-8 rounded-lg bg-brand-grey-100 flex items-center justify-center text-brand-grey-600 hover:bg-brand-red hover:text-white transition-all duration-300"
                      aria-label="LinkedIn"
                    >
              ...
              {VALUES.map((v, i) => (
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        i % 2 === 0 ? "rgba(200,16,46,0.08)" : "#F0F0F0",
                      color: "#C8102E",
                    }}
                  >
                    {v.icon}
                  ...
                  <h3
                    className="font-bold text-brand-grey-900 mb-3 text-base"
                    style={{ fontFamily: "var(--font-display)" }}
                  >
                    {v.title}
                  </h3>
        ...
        >
          ...
          <div className="max-w-3xl mx-auto px-4 relative z-10">
            ...
            <p className="text-white/75 text-lg mb-10 leading-relaxed">
              ...
              your next great team — SIS Global Workforce Solutions is your
              partner.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/"
                className="btn-outline !text-white !border-white/50 hover:!bg-white/20"
              >
                Get In Touch
              </Link>
            </div>
