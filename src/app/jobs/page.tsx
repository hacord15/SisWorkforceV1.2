...
const BENEFITS = [
  {
    ...
    desc:  "Transparent recruitment with no hidden fees or misleading terms — ever.",
  },
  {
    icon: <Star         size={22} />,
    title: "Zero Fake Promises",
    desc:  "Every offer we present is verified, genuine, and backed by a signed contract.",
  },
  {
    icon: <BookOpen     size={22} />,
    title: "Training Support",
    desc:  "Pre-departure skill upgrades and orientation to help you hit the ground running.",
  },
  {
    icon: <FileText     size={22} />,
    title: "Visa Guidance",
    desc:  "End-to-end documentation and visa processing support so nothing gets missed.",
  },
  {
    icon: <HeartPulse   size={22} />,
    title: "Insurance Support",
    desc:  "Health and travel insurance assistance to keep you protected abroad.",
  },
  {
    icon: <Users        size={22} />,
    title: "Family Connect",
    desc:  "Regular updates and support channels to keep your family informed and at ease.",
  },
  {
    icon: <TrendingUp   size={22} />,
    title: "Career Growth",
    desc:  "Placements with employers who invest in learning, progression, and long-term roles.",
  },
  {
    icon: <Headphones   size={22} />,
    title: "Post-Deployment Support",
    desc:  "Our team stays in touch after you land — you're never alone once you're there.",
  },
];
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-2 mt-10">
                  <Link
                    ...
                    className={`px-3 h-9 rounded text-sm font-semibold border transition-colors ${
                      currentPage === 1
                        ? "border-brand-grey-200 text-brand-grey-300 cursor-not-allowed pointer-events-none"
                        : "border-brand-grey-200 text-brand-grey-700 hover:border-brand-red hover:text-brand-red"
                    }`}
                  >
                    ← Previous
                  </Link>
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1)
                    ...
                    .map((pageNum, index, array) => {
                      if (index > 0 && pageNum - array[index - 1] > 1) {
                        return (
                          <span key={`ellipsis-${pageNum}`} className="w-9 h-9 flex items-center justify-center text-sm text-brand-grey-500">
                            ...
                          </span>
                        );
                      }
                      return (
                        <Link
                          ...
                          className={`w-9 h-9 rounded text-sm font-semibold transition-colors flex items-center justify-center ${
                            pageNum === currentPage
                              ? "bg-[#C8102E] text-white"
                              : "border border-brand-grey-200 text-brand-grey-700 hover:border-brand-red hover:text-brand-red bg-white"
                          }`}
                        >
                          {pageNum}
                        </Link>
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            ...
            <div
              ...
              style={{ background: "radial-gradient(ellipse 50% 70% at 10% 50%, rgba(200,16,46,0.10) 0%, transparent 70%)" }}
            />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {BENEFITS.map((b) => (
                <div
                  key={b.title}
                  className="group rounded-2xl p-6 transition-all duration-250 hover:border-brand-red/50"
                  style={{
                ...
                >
                  {/* Icon */}
                  <div
                    className="w-11 h-11 rounded-xl flex items-center justify-center mb-4 transition-colors group-hover:bg-brand-red"
            ...
            <div className="text-center mt-12">
              <Link href="/contact#candidate" className="btn-primary inline-flex items-center gap-2">
