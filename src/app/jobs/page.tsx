    ...
    <>
      ...
      <main>
        ...
        <div className="relative" style={{ borderBottom: "1px solid #E5E5E5" }}>
          <div className="absolute inset-0" style={{ backgroundImage: "url('/assets/job_banner.png')", backgroundSize: "cover", backgroundPosition: "right center", backgroundRepeat: "no-repeat" }} />
        ...
        <section className="py-20 relative overflow-hidden" style={{ background: "linear-gradient(135deg,#171717 0%,#262626 100%)" }}>
          <div className="absolute inset-0 opacity-25 mix-blend-screen pointer-events-none" style={{ backgroundImage: "url('/assets/job_why_work.png')", backgroundSize: "cover", backgroundPosition: "left center" }} />
